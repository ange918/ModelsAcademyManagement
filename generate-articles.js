...
// Importer les articles (en Node.js, on doit lire le fichier)
const articlesContent = fs.readFileSync('data/articles.js', 'utf8');
eval(articlesContent); // Charge BLOG_ARTICLES dans le scope

// Template HTML pour chaque article
function generateArticlePage(article) {
  // Convertir le titre en slug pour l'URL
  const slug = article.id.toString().padStart(2, '0');
...
console.log(`\n🎉 ${BLOG_ARTICLES.length} pages d'articles générées avec succès !`);
